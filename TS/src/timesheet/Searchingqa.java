...
public class Searchingqa extends HttpServlet
{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
	{
       ...
       ResultSet  rs =stmt.executeQuery("SELECT * FROM QA WHERE EMPID='"+empid+"'");
       ...
       while(rs.next()) 
          {
           ...
           total = (duration1+duration2+duration3+duration4+duration5+duration6);
		...
		req.getRequestDispatcher("printvalueqa.jsp").forward(req, resp);
