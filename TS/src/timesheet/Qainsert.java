...
public class Qainsert extends HttpServlet  
{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
	{
	  ...
	  //  System.out.println("Created DB Connection....");
       ...
       stmt.executeQuery("insert into qa(empid,empname,date1,task1,duration1,task2,duration2,task3,duration3,task4,duration4,task5,duration5,task6,duration6) VALUES('" +empid+ "','" +empname+"','"+date1+"','"+task1+"','"+duration1+"','"+task2+"','"+duration2+"','"+task3+"','"+duration3+"','"+task4+"','"+duration4+"','"+task5+"','"+duration5+"','"+task6+"','"+duration6+"')");
